...
const AboutServiceItem = ({ servicer_img, name, title }) => {
  return (
    <>
      <div
        className="tp-service-two text-center swiper-slide mb-30 wow fadeInUp"
        data-wow-delay=".4s"
      >
        <div className="tp-service-two-img mb-35">
          <div className="tp-service-two-img-box">
            <img
              src={`assets/img/service/service-${servicer_img}.jpg`}
              className="img-fluid"
              alt="img not found"
            />
          </div>
          <div className="tp-service-two-icon-wrapper">
            <div className="tp-service-two-icon">
              ...
              <a href="javascript:void(0);" className="share-icon">
                <i>
                  <RiShareLine className="share_icon" />
                </i>
              </a>
            </div>
          </div>
        ...
        <div className="tp-service-two-content">
          <h4 className="tp-service-two-title">
