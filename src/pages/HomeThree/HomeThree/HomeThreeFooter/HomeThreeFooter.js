                ...
                >
                  <div className="tp-footer-info tp-footer-info-three">
                    <div className="tp-footer-info-logo mb-35">
                      <Link to="/">
                        <img
                          src="assets/img/logoJugaad/circleLogo.png"
                          className="img-fluid"
                          alt="img not found"
                        />
                      </Link>
                    </div>
                    <p className="text-white mb-35">
                      Pulvinar seneius morbi to quisque nunc a towa faucibus
                      netus a mone lestie nice disease
                    </p>
                  ...
                  <div className="tp-footer-news tp-footer-news-three">
                    <div className="tp-footer-news-single tp-footer-news-three-single mb-10">
                      <div className="tp-footer-news-three-single-img">
                        <Link to="/blogDetails">
                          <img
                            src="assets/img/footer/footer-blog-1.png"
                            className="img-fluid"
                            alt="img-not-found"
                          />
                        </Link>
                    ...
                    <div className="tp-footer-news-single tp-footer-news-three-single mb-10">
                      <div className="tp-footer-news-three-single-img">
                        <Link to="/blogDetails">
                          <img
                            src="assets/img/footer/footer-blog-2.png"
                            className="img-fluid"
                            alt="img-not-found"
                          />
                        </Link>
            ...
            <div className="row">
              <div className="col-12">
                <div className="tp-copyright tp-copyright-two text-center">
                  <p className="m-0">
                    Copyright ©2021 <span>Theme_pure</span>. All Rights Reserved
                    Copyright
                  </p>
                </div>
              </div>
